...
*/
#if 0
    /* ufko Not needed anymore. Always on. */
    #define LFS
    #ifdef LFS
...
/* cell types, do not change these without changing rebel.c/cellCopy() */
...
#define CELL_FN (12 | ENVELOPE_TYPE_MASK | LIST_TYPE_MASK | EVAL_SELF_TYPE_MASK)
...
#define ERR_NAMED_FUNCTION_DEFINITION_EXPECTED_FUNC 79
#define ERR_QUOTED_SYMBOL_EXPECTED 80 
#define MAX_ERROR_NUMBER 80 
...
/* used inf setDefine() define in rebel.c */
#define SET_SET 1
