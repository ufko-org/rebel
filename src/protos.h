/* protos.h function prototypes for Rebel
...
CELL *evaluateFn(CELL *fnCell, CELL *arg, SYMBOL *newContext);
CELL *evaluateFnMacro(CELL *fnMacroCell, CELL *arg, SYMBOL *newContext);
